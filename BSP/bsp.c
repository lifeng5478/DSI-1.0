...
*********************************************************************************************************
*/
char I2c_Buf_Read1[1];
extern GUI_CONST_STORAGE GUI_FONT GUI_FontSWScrpc60;
extern GUI_CONST_STORAGE GUI_FONT GUI_FontCommercialScriptBT20;
void  BSP_Init (void)
{
...
// TPAD_Init();
	...
	GTP_Init_Panel();
	I2C_EE_Init();
	I2C_EE_BufferRead(I2c_Buf_Read1,1,1);
	tmp=I2c_Buf_Read1[0];
	GUI_Init();
...
//  GUI_SetBkColor(GUI_TRANSPARENT); 
//	GUI_SelectLayer(1);
	GUI_SetFont(&GUI_FontCommercialScriptBT20);
	GUI_DispStringAt("Edit By LiFeng",680,420);
	GUI_DispStringAt("Version 1.0",700,450);
	GUI_SetFont(&GUI_FontSWScrpc60);
		GUI_DispStringAt("D",300,200);
		GUI_Delay(1000);
		GUI_DispStringAt("S",400,200);
				GUI_Delay(1000);
		GUI_DispStringAt("I",500,200);
	GUI_Delay(1000);
//	GUI_Clear();
